    ...
    <Stack rowGap={5} py={6}>
        ...
        <Stack rowGap={2}>
          {aboutMe.map(element => {
            ...
            if (element.type === "text") {
              renderContent = <Typography key={element.i18nTag} variant="body1" textAlign='justify'>{t(element.i18nTag)}</Typography>
            }
                ...
                <Stack key={element.i18nTag}>
                  ...
                  <List>
                    {element.content?.map(element => (
                      <ListItem sx={{ pl: 0, py: 0, alignItems: 'flex-start' }} key={element.i18nTag}>
                        <ListItemIcon sx={{ minWidth: 0, mt: 0.75 }}>
      ...
      <Stack rowGap={8}>
        ...
        <Grid container rowSpacing={5}>
          ...
          <KnowloedgeContainer source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/ruby/ruby-original-wordmark.svg" knowledgeName="RoR" />
